...
import com.comeonbabys.android.app.view.customview.CircularImageView;
    ...
    private void loadAvatar() {
        if (!TextUtils.isEmpty(profileDto.getAvatar())) {
            ...
            ImageLoader.getInstance().displayImage(imageUrl,
                    ...
                    profileDto.isGender() ? com.comeonbabys.android.app.common.Constants.PROFILE_AVATAR_MALE_DISPLAY_OPTIONS
                            : com.comeonbabys.android.app.common.Constants.PROFILE_AVATAR_FEMALE_DISPLAY_OPTIONS);
        }
    }
